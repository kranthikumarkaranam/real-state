...
import bathtub from "public/bathtub.svg";
import arrowsOut from "public/arrowsout.svg";
import ellipse1 from "public/ellipse-1@2x.png";
import shareNetwork from "public/sharenetwork.svg";
    ...
    >
      ...
      <div className="self-stretch flex flex-row py-0 px-2.5 items-start justify-start gap-[17px] text-[10.84px] text-gray-500">
        <div className="flex flex-row items-center justify-start gap-[4.35px]">
          <Image className="relative w-[17.42px] h-[17.42px]" alt="" src={car} />
